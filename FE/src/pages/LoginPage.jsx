...
export default function LoginPage() {
  ...
  // Show OAuth error from query params
  useEffect(() => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex flex-col items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">AI Trainer English</span>
          </Link>
        ...
        <div className="card shadow-lg">
          {/* Error */}
          {error && (
            <div className="flex items-start gap-3 bg-red-50 text-red-700 border border-red-200 rounded-xl p-3 mb-5 text-sm">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-2.5 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200"
            >
